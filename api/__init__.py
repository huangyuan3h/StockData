...
def register_router(app: Flask):
    ...
    # functional endpoint
    app.add_url_rule('/sync/stocks', 'sync_stock_lists', methods=['get'], view_func=start_sync_stock_list)

    app.add_url_rule('/sync/kline/all', 'sync_all_stock', methods=['get'], view_func=sync_all_stock)

    app.add_url_rule('/sync/kline_by_code/<string:code>', 'sync_stock_by_day', methods=['get'],
